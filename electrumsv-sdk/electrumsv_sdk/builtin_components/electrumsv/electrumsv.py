...
from .install import configure_paths_and_datadir_electrumsv, fetch_electrumsv, packages_electrumsv, \
...
def install(app_state):
    ...
    configure_paths_and_datadir_electrumsv(app_state, repo, branch)
