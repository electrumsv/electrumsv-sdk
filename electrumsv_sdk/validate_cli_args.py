...
class ValidateCliArgs:
    ...
    def handle_top_level_args(self, parsed_args) -> None:
    ...
    def handle_install_args(self, parsed_args) -> None:
    ...
    def handle_start_args(self, parsed_args) -> None:
    ...
    def handle_stop_args(self, parsed_args) -> None:
        """takes no arguments"""
    ...
    def handle_reset_args(self, parsed_args) -> None:
        """takes no arguments"""
    ...
    def handle_node_args(self, parsed_args) -> None:
    ...
    def handle_status_args(self, _parsed_args) -> None:
        return
