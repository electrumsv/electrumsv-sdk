...
def maybe_change_postgres_port() -> None:
    if POSTGRES_PORT != 5432:
        ...
        os.environ['ConnectionStrings__DBConnectionString'] = DBConnectionStringDDL.replace("Port=5432", f"Port={POSTGRES_PORT}")
        os.environ['ConnectionStrings__DBConnectionString'] = DBConnectionStringMaster.replace("Port=5432", f"Port={POSTGRES_PORT}")
